...
class LabResult extends Model
{
    ...
    {
        $data = labResult::select('lab_results.*', 'b.file_path as recommendation_file_path', 'b.recommendation', 'c.firstname', 'c.lastname', 'd.firstname as clerk_firstname', 'd.lastname as clerk_lastname', DB::raw('DATE_FORMAT(lab_results.created_at, "%b %e, %Y") as upload_date'))
                ->leftJoin('recommendations as b', 'b.id', 'lab_results.recommendation_id')
                ->leftJoin('client_information as c', 'c.client_id', 'lab_results.client_id')
