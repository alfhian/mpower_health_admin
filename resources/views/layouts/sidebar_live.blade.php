            ...
            @if ($role == 1)
                <ul class="list-group border-0 med-text">
                    ...
                    <li class="px-4 list-group-item border-0 text-muted @if (Request::is('profile_management')) active @endif"
                        onclick="window.location = '{{ url('/profile_management') }}'">
                        @if (Request::is('profile_management'))
                            <img src="{{ asset('img/profileicons/profile_active.png') }}" alt="profile" width="15px"
                                class="me-3">
                        @else
                    ...
                    <li class="px-4 list-group-item border-0 text-muted @if (Request::is('lab_result')) active @endif"
                        onclick="window.location = '{{ url('/lab_result') }}'">
                    ...
                    <li class="px-4 list-group-item border-0 text-muted @if (Request::is('recommendation')) active @endif"
                        onclick="window.location = '{{ url('/recommendation') }}'">
                        @if (Request::is('recommendation'))
                            <img src="{{ asset('img/profileicons/recommendations_active.png') }}" alt="recommendations"
                                width="15px" class="me-3">
                        @else
                            <img src="{{ asset('img/profileicons/recommendations_inactive.png') }}"
                                alt="recommendations" width="15px" class="me-3">
                        @endif
                        Recomendations
                    </li>
                ...
                <ul class="list-group border-0 med-text">
                    ...
                    <li class="px-4 list-group-item border-0 text-muted @if (Request::is('user_management')) active @endif"
                        ...
                        @if (Request::is('user_management'))
                            <img src="{{ asset('img/profileicons/recommendations_active.png') }}" alt="user_management"
                                width="15px" class="me-3">
                        @else
                            <img src="{{ asset('img/profileicons/recommendations_inactive.png') }}"
